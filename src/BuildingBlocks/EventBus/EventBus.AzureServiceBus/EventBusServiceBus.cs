...
public class EventBusServiceBus : BaseEventBus
{
    ...
    private ITopicClient CreateTopicClient()
    {
        ...
        //topic in zaten var olduğundan emin olduk  
    ...
    {
        var eventName = @event.GetType().Name; //Örneğin : OrderCreatedIntegrationEvent

        eventName = ProcessEventName(eventName);  // Örneğin : OrderCreated

        //önce string json nesnesine daha sonra oluşan string veriyi byte array e çevirdik.
    ...
    public override void UnSubscribe<T, TH>()
    {
        ...
        try
        {
            ...
            //burada sadece rule u siliyoruz bir subscription silme işlemi yok 
            subscriptionClient
    ...
    private ISubscriptionClient CreateSubscriptionClientIfNotExist(string eventName)
    {
        ...
        var exist = managementClient.SubscriptionExistsAsync(EventBusConfig.DefaultTopicName, GetSubName(eventName)).GetAwaiter()
            .GetResult();
